package net.azisaba.spigotLog4j2Fix.v1_11_R1.util;
...
import net.minecraft.server.v1_11_R1.ChatComponentScore;
import net.minecraft.server.v1_11_R1.ChatComponentSelector;
